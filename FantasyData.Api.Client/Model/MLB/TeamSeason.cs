...
public class TeamSeason
{
    ...
    [DataMember(Name = "AtBats", Order = 11)]
    ...
    [DataMember(Name = "Singles", Order = 14)]
    ...
    [DataMember(Name = "Doubles", Order = 15)]
    ...
    [DataMember(Name = "Triples", Order = 16)]
    ...
    [DataMember(Name = "HomeRuns", Order = 17)]
    ...
    [DataMember(Name = "RunsBattedIn", Order = 18)]
    ...
    [DataMember(Name = "BattingAverage", Order = 19)]
    ...
    [DataMember(Name = "Strikeouts", Order = 21)]
    ...
    [DataMember(Name = "Walks", Order = 22)]
    ...
    [DataMember(Name = "HitByPitch", Order = 23)]
    ...
    [DataMember(Name = "Sacrifices", Order = 24)]
    ...
    [DataMember(Name = "SacrificeFlies", Order = 25)]
    ...
    [DataMember(Name = "GroundIntoDoublePlay", Order = 26)]
    ...
    [DataMember(Name = "StolenBases", Order = 27)]
    ...
    [DataMember(Name = "CaughtStealing", Order = 28)]
    ...
    [DataMember(Name = "PitchesSeen", Order = 29)]
    ...
    [DataMember(Name = "OnBasePercentage", Order = 30)]
    ...
    [DataMember(Name = "SluggingPercentage", Order = 31)]
    ...
    [DataMember(Name = "OnBasePlusSlugging", Order = 32)]
    ...
    [DataMember(Name = "Errors", Order = 33)]
    ...
    [DataMember(Name = "Losses", Order = 35)]
    ...
    [DataMember(Name = "Saves", Order = 36)]
    ...
    [DataMember(Name = "InningsPitchedDecimal", Order = 37)]
    ...
    [DataMember(Name = "TotalOutsPitched", Order = 38)]
    ...
    [DataMember(Name = "InningsPitchedFull", Order = 39)]
    ...
    [DataMember(Name = "InningsPitchedOuts", Order = 40)]
    ...
    [DataMember(Name = "EarnedRunAverage", Order = 41)]
    ...
    [DataMember(Name = "PitchingHits", Order = 42)]
    ...
    [DataMember(Name = "PitchingRuns", Order = 43)]
    ...
    [DataMember(Name = "PitchingEarnedRuns", Order = 44)]
    ...
    [DataMember(Name = "PitchingWalks", Order = 45)]
    ...
    [DataMember(Name = "PitchingStrikeouts", Order = 46)]
    ...
    [DataMember(Name = "PitchingHomeRuns", Order = 47)]
    ...
    [DataMember(Name = "PitchesThrown", Order = 48)]
    ...
    [DataMember(Name = "PitchesThrownStrikes", Order = 49)]
    ...
    [DataMember(Name = "WalksHitsPerInningsPitched", Order = 50)]
    ...
    [DataMember(Name = "PitchingBattingAverageAgainst", Order = 51)]
    ...
    [DataMember(Name = "GrandSlams", Order = 52)]
    ...
    [DataMember(Name = "FantasyPointsFanDuel", Order = 53)]
    ...
    [DataMember(Name = "FantasyPointsDraftKings", Order = 54)]
    ...
    [DataMember(Name = "FantasyPointsYahoo", Order = 55)]
    ...
    [DataMember(Name = "PlateAppearances", Order = 56)]
    ...
    [DataMember(Name = "TotalBases", Order = 57)]
    ...
    [DataMember(Name = "FlyOuts", Order = 58)]
    ...
    [DataMember(Name = "GroundOuts", Order = 59)]
    ...
    [DataMember(Name = "LineOuts", Order = 60)]
    ...
    [DataMember(Name = "PopOuts", Order = 61)]
    ...
    [DataMember(Name = "IntentionalWalks", Order = 62)]
    ...
    [DataMember(Name = "ReachedOnError", Order = 63)]
    ...
    [DataMember(Name = "BallsInPlay", Order = 64)]
    ...
    [DataMember(Name = "BattingAverageOnBallsInPlay", Order = 65)]
    ...
    [DataMember(Name = "WeightedOnBasePercentage", Order = 66)]
    ...
    [DataMember(Name = "PitchingSingles", Order = 67)]
    ...
    [DataMember(Name = "PitchingDoubles", Order = 68)]
    ...
    [DataMember(Name = "PitchingTriples", Order = 69)]
    ...
    [DataMember(Name = "PitchingGrandSlams", Order = 70)]
    ...
    [DataMember(Name = "PitchingHitByPitch", Order = 71)]
    ...
    [DataMember(Name = "PitchingSacrifices", Order = 72)]
    ...
    [DataMember(Name = "PitchingSacrificeFlies", Order = 73)]
    ...
    [DataMember(Name = "PitchingGroundIntoDoublePlay", Order = 74)]
    ...
    [DataMember(Name = "PitchingCompleteGames", Order = 75)]
    ...
    [DataMember(Name = "PitchingShutOuts", Order = 76)]
    ...
    [DataMember(Name = "PitchingNoHitters", Order = 77)]
    ...
    [DataMember(Name = "PitchingPerfectGames", Order = 78)]
    ...
    [DataMember(Name = "PitchingPlateAppearances", Order = 79)]
    ...
    [DataMember(Name = "PitchingTotalBases", Order = 80)]
    ...
    [DataMember(Name = "PitchingFlyOuts", Order = 81)]
    ...
    [DataMember(Name = "PitchingGroundOuts", Order = 82)]
    ...
    [DataMember(Name = "PitchingLineOuts", Order = 83)]
    ...
    [DataMember(Name = "PitchingPopOuts", Order = 84)]
    ...
    [DataMember(Name = "PitchingIntentionalWalks", Order = 85)]
    ...
    [DataMember(Name = "PitchingReachedOnError", Order = 86)]
    ...
    [DataMember(Name = "PitchingCatchersInterference", Order = 87)]
    ...
    [DataMember(Name = "PitchingBallsInPlay", Order = 88)]
    ...
    [DataMember(Name = "PitchingOnBasePercentage", Order = 89)]
    ...
    [DataMember(Name = "PitchingSluggingPercentage", Order = 90)]
    ...
    [DataMember(Name = "PitchingOnBasePlusSlugging", Order = 91)]
    ...
    [DataMember(Name = "PitchingStrikeoutsPerNineInnings", Order = 92)]
    ...
    [DataMember(Name = "PitchingWalksPerNineInnings", Order = 93)]
    ...
    [DataMember(Name = "PitchingBattingAverageOnBallsInPlay", Order = 94)]
    ...
    [DataMember(Name = "PitchingWeightedOnBasePercentage", Order = 95)]
    ...
    [DataMember(Name = "DoublePlays", Order = 96)]
    ...
    [DataMember(Name = "PitchingDoublePlays", Order = 97)]
    ...
    [DataMember(Name = "BattingOrderConfirmed", Order = 98)]
    ...
    [DataMember(Name = "IsolatedPower", Order = 99)]
    ...
    [DataMember(Name = "FieldingIndependentPitching", Order = 100)]
    ...
    [DataMember(Name = "PitchingQualityStarts", Order = 101)]
    ...
    [DataMember(Name = "PitchingInningStarted", Order = 102)]
    ...
    [DataMember(Name = "LeftOnBase", Order = 103)]
    ...
    [DataMember(Name = "PitchingHolds", Order = 104)]
    ...
    [DataMember(Name = "PitchingBlownSaves", Order = 105)]
    ...
    [DataMember(Name = "SubstituteBattingOrder", Order = 106)]
    ...
    [DataMember(Name = "SubstituteBattingOrderSequence", Order = 107)]
    ...
    [DataMember(Name = "FantasyPointsFantasyDraft", Order = 108)]
