...
public partial class GameStat
{
    ...
    [DataMember(Name = "AtBats", Order = 13)]
    ...
    [DataMember(Name = "Singles", Order = 16)]
    ...
    [DataMember(Name = "Doubles", Order = 17)]
    ...
    [DataMember(Name = "Triples", Order = 18)]
    ...
    [DataMember(Name = "HomeRuns", Order = 19)]
    ...
    [DataMember(Name = "RunsBattedIn", Order = 20)]
    ...
    [DataMember(Name = "BattingAverage", Order = 21)]
    ...
    [DataMember(Name = "Strikeouts", Order = 23)]
    ...
    [DataMember(Name = "Walks", Order = 24)]
    ...
    [DataMember(Name = "HitByPitch", Order = 25)]
    ...
    [DataMember(Name = "Sacrifices", Order = 26)]
    ...
    [DataMember(Name = "SacrificeFlies", Order = 27)]
    ...
    [DataMember(Name = "GroundIntoDoublePlay", Order = 28)]
    ...
    [DataMember(Name = "StolenBases", Order = 29)]
    ...
    [DataMember(Name = "CaughtStealing", Order = 30)]
    ...
    [DataMember(Name = "PitchesSeen", Order = 31)]
    ...
    [DataMember(Name = "OnBasePercentage", Order = 32)]
    ...
    [DataMember(Name = "SluggingPercentage", Order = 33)]
    ...
    [DataMember(Name = "OnBasePlusSlugging", Order = 34)]
    ...
    [DataMember(Name = "Errors", Order = 35)]
    ...
    [DataMember(Name = "Losses", Order = 37)]
    ...
    [DataMember(Name = "Saves", Order = 38)]
    ...
    [DataMember(Name = "InningsPitchedDecimal", Order = 39)]
    ...
    [DataMember(Name = "TotalOutsPitched", Order = 40)]
    ...
    [DataMember(Name = "InningsPitchedFull", Order = 41)]
    ...
    [DataMember(Name = "InningsPitchedOuts", Order = 42)]
    ...
    [DataMember(Name = "EarnedRunAverage", Order = 43)]
    ...
    [DataMember(Name = "PitchingHits", Order = 44)]
    ...
    [DataMember(Name = "PitchingRuns", Order = 45)]
    ...
    [DataMember(Name = "PitchingEarnedRuns", Order = 46)]
    ...
    [DataMember(Name = "PitchingWalks", Order = 47)]
    ...
    [DataMember(Name = "PitchingStrikeouts", Order = 48)]
    ...
    [DataMember(Name = "PitchingHomeRuns", Order = 49)]
    ...
    [DataMember(Name = "PitchesThrown", Order = 50)]
    ...
    [DataMember(Name = "PitchesThrownStrikes", Order = 51)]
    ...
    [DataMember(Name = "WalksHitsPerInningsPitched", Order = 52)]
    ...
    [DataMember(Name = "PitchingBattingAverageAgainst", Order = 53)]
    ...
    [DataMember(Name = "GrandSlams", Order = 54)]
    ...
    [DataMember(Name = "FantasyPointsYahoo", Order = 57)]
    ...
    [DataMember(Name = "PlateAppearances", Order = 58)]
    ...
    [DataMember(Name = "TotalBases", Order = 59)]
    ...
    [DataMember(Name = "FlyOuts", Order = 60)]
    ...
    [DataMember(Name = "GroundOuts", Order = 61)]
    ...
    [DataMember(Name = "LineOuts", Order = 62)]
    ...
    [DataMember(Name = "PopOuts", Order = 63)]
    ...
    [DataMember(Name = "IntentionalWalks", Order = 64)]
    ...
    [DataMember(Name = "ReachedOnError", Order = 65)]
    ...
    [DataMember(Name = "BallsInPlay", Order = 66)]
    ...
    [DataMember(Name = "BattingAverageOnBallsInPlay", Order = 67)]
    ...
    [DataMember(Name = "WeightedOnBasePercentage", Order = 68)]
    ...
    [DataMember(Name = "PitchingSingles", Order = 69)]
    ...
    [DataMember(Name = "PitchingDoubles", Order = 70)]
    ...
    [DataMember(Name = "PitchingTriples", Order = 71)]
    ...
    [DataMember(Name = "PitchingGrandSlams", Order = 72)]
    ...
    [DataMember(Name = "PitchingHitByPitch", Order = 73)]
    ...
    [DataMember(Name = "PitchingSacrifices", Order = 74)]
    ...
    [DataMember(Name = "PitchingSacrificeFlies", Order = 75)]
    ...
    [DataMember(Name = "PitchingGroundIntoDoublePlay", Order = 76)]
    ...
    [DataMember(Name = "PitchingCompleteGames", Order = 77)]
    ...
    [DataMember(Name = "PitchingShutOuts", Order = 78)]
    ...
    [DataMember(Name = "PitchingNoHitters", Order = 79)]
    ...
    [DataMember(Name = "PitchingPerfectGames", Order = 80)]
    ...
    [DataMember(Name = "PitchingPlateAppearances", Order = 81)]
    ...
    [DataMember(Name = "PitchingTotalBases", Order = 82)]
    ...
    [DataMember(Name = "PitchingFlyOuts", Order = 83)]
    ...
    [DataMember(Name = "PitchingGroundOuts", Order = 84)]
    ...
    [DataMember(Name = "PitchingLineOuts", Order = 85)]
    ...
    [DataMember(Name = "PitchingPopOuts", Order = 86)]
    ...
    [DataMember(Name = "PitchingIntentionalWalks", Order = 87)]
    ...
    [DataMember(Name = "PitchingReachedOnError", Order = 88)]
    ...
    [DataMember(Name = "PitchingCatchersInterference", Order = 89)]
    ...
    [DataMember(Name = "PitchingBallsInPlay", Order = 90)]
    ...
    [DataMember(Name = "PitchingOnBasePercentage", Order = 91)]
    ...
    [DataMember(Name = "PitchingSluggingPercentage", Order = 92)]
    ...
    [DataMember(Name = "PitchingOnBasePlusSlugging", Order = 93)]
    ...
    [DataMember(Name = "PitchingStrikeoutsPerNineInnings", Order = 94)]
    ...
    [DataMember(Name = "PitchingWalksPerNineInnings", Order = 95)]
    ...
    [DataMember(Name = "PitchingBattingAverageOnBallsInPlay", Order = 96)]
    ...
    [DataMember(Name = "PitchingWeightedOnBasePercentage", Order = 97)]
    ...
    [DataMember(Name = "DoublePlays", Order = 98)]
    ...
    [DataMember(Name = "PitchingDoublePlays", Order = 99)]
    ...
    [DataMember(Name = "BattingOrderConfirmed", Order = 100)]
    ...
    [DataMember(Name = "IsolatedPower", Order = 101)]
    ...
    [DataMember(Name = "FieldingIndependentPitching", Order = 102)]
    ...
    [DataMember(Name = "PitchingQualityStarts", Order = 103)]
    ...
    [DataMember(Name = "PitchingInningStarted", Order = 104)]
    ...
    [DataMember(Name = "LeftOnBase", Order = 105)]
    ...
    [DataMember(Name = "PitchingHolds", Order = 106)]
    ...
    [DataMember(Name = "PitchingBlownSaves", Order = 107)]
    ...
    [DataMember(Name = "SubstituteBattingOrder", Order = 108)]
    ...
    [DataMember(Name = "SubstituteBattingOrderSequence", Order = 109)]
    ...
    [DataMember(Name = "FantasyPointsFantasyDraft", Order = 110)]
