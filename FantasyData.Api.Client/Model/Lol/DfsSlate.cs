...
public partial class DfsSlate
{
    ...
    /// <summary>
    /// The day (in UTC) that the slate begins (assigned by the operator).
    /// </summary>
    ...
    /// <summary>
    /// The date/time (in UTC) that the slate begins (assigned by the operator).
    /// </summary>
    ...
    /// <summary>
    /// The Id of the video game related to this slate (CS:GO, LOL, etc.)
    /// </summary>
    [Description("The Id of the video game related to this slate (CS:GO, LOL, etc.)")]
    [DataMember(Name = "VideoGameId", Order = 15)]
