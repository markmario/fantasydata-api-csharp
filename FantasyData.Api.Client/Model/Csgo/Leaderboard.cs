...
public class Leaderboard
{
    ...
    /// <summary>
    /// Indicates whether the stats for this leaderboard have been loaded and are final
    /// </summary>
    [Description("Indicates whether the stats for this leaderboard have been loaded and are final")]
    [DataMember(Name = "IsClosed", Order = 6)]
    ...
    [DataMember(Name = "UpdatedUtc", Order = 13)]
    ...
    [DataMember(Name = "Headshots", Order = 20)]
    ...
    [DataMember(Name = "AverageDamagePerRound", Order = 21)]
    ...
    [DataMember(Name = "Rating", Order = 23)]
    ...
    [DataMember(Name = "EntryKills", Order = 24)]
    ...
    [DataMember(Name = "QuadKills", Order = 25)]
    ...
    [DataMember(Name = "Clutch1v2s", Order = 27)]
    ...
    [DataMember(Name = "Clutch1v3s", Order = 28)]
    ...
    [DataMember(Name = "Clutch1v4s", Order = 29)]
    ...
    [DataMember(Name = "Clutch1v5s", Order = 30)]
