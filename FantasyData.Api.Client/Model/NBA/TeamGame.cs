...
public class TeamGame
{
    ...
    [DataMember(Name = "Minutes", Order = 23)]
    ...
    [DataMember(Name = "Seconds", Order = 24)]
    ...
    [DataMember(Name = "FieldGoalsMade", Order = 25)]
    ...
    [DataMember(Name = "FieldGoalsAttempted", Order = 26)]
    ...
    [DataMember(Name = "FieldGoalsPercentage", Order = 27)]
    ...
    [DataMember(Name = "EffectiveFieldGoalsPercentage", Order = 28)]
    ...
    [DataMember(Name = "TwoPointersMade", Order = 29)]
    ...
    [DataMember(Name = "TwoPointersAttempted", Order = 30)]
    ...
    [DataMember(Name = "TwoPointersPercentage", Order = 31)]
    ...
    [DataMember(Name = "ThreePointersMade", Order = 32)]
    ...
    [DataMember(Name = "ThreePointersAttempted", Order = 33)]
    ...
    [DataMember(Name = "ThreePointersPercentage", Order = 34)]
    ...
    [DataMember(Name = "FreeThrowsMade", Order = 35)]
    ...
    [DataMember(Name = "FreeThrowsAttempted", Order = 36)]
    ...
    [DataMember(Name = "FreeThrowsPercentage", Order = 37)]
    ...
    [DataMember(Name = "OffensiveRebounds", Order = 38)]
    ...
    [DataMember(Name = "DefensiveRebounds", Order = 39)]
    ...
    [DataMember(Name = "Rebounds", Order = 40)]
    ...
    [DataMember(Name = "OffensiveReboundsPercentage", Order = 41)]
    ...
    [DataMember(Name = "DefensiveReboundsPercentage", Order = 42)]
    ...
    [DataMember(Name = "TotalReboundsPercentage", Order = 43)]
    ...
    [DataMember(Name = "Assists", Order = 44)]
    ...
    [DataMember(Name = "Steals", Order = 45)]
    ...
    [DataMember(Name = "Turnovers", Order = 47)]
    ...
    [DataMember(Name = "PersonalFouls", Order = 48)]
    ...
    [DataMember(Name = "Points", Order = 49)]
    ...
    [DataMember(Name = "TrueShootingAttempts", Order = 50)]
    ...
    [DataMember(Name = "TrueShootingPercentage", Order = 51)]
    ...
    [DataMember(Name = "PlayerEfficiencyRating", Order = 52)]
    ...
    [DataMember(Name = "AssistsPercentage", Order = 53)]
    ...
    [DataMember(Name = "StealsPercentage", Order = 54)]
    ...
    [DataMember(Name = "BlocksPercentage", Order = 55)]
    ...
    [DataMember(Name = "TurnOversPercentage", Order = 56)]
    ...
    [DataMember(Name = "UsageRatePercentage", Order = 57)]
    ...
    [DataMember(Name = "FantasyPointsFanDuel", Order = 58)]
    ...
    [DataMember(Name = "FantasyPointsDraftKings", Order = 59)]
    ...
    [DataMember(Name = "FantasyPointsYahoo", Order = 60)]
    ...
    [DataMember(Name = "PlusMinus", Order = 61)]
    ...
    [DataMember(Name = "DoubleDoubles", Order = 62)]
    ...
    [DataMember(Name = "TripleDoubles", Order = 63)]
    ...
    [DataMember(Name = "FantasyPointsFantasyDraft", Order = 64)]
    ...
    [DataMember(Name = "IsClosed", Order = 65)]
    ...
    [DataMember(Name = "LineupConfirmed", Order = 66)]
    ...
    [DataMember(Name = "LineupStatus", Order = 67)]
