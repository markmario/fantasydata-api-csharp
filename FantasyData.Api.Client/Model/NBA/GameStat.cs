...
public partial class GameStat
{
    ...
    [DataMember(Name = "Seconds", Order = 14)]
    ...
    [DataMember(Name = "FieldGoalsMade", Order = 15)]
    ...
    [DataMember(Name = "FieldGoalsAttempted", Order = 16)]
    ...
    [DataMember(Name = "FieldGoalsPercentage", Order = 17)]
    ...
    [DataMember(Name = "EffectiveFieldGoalsPercentage", Order = 18)]
    ...
    [DataMember(Name = "TwoPointersMade", Order = 19)]
    ...
    [DataMember(Name = "TwoPointersAttempted", Order = 20)]
    ...
    [DataMember(Name = "TwoPointersPercentage", Order = 21)]
    ...
    [DataMember(Name = "ThreePointersMade", Order = 22)]
    ...
    [DataMember(Name = "ThreePointersAttempted", Order = 23)]
    ...
    [DataMember(Name = "ThreePointersPercentage", Order = 24)]
    ...
    [DataMember(Name = "FreeThrowsMade", Order = 25)]
    ...
    [DataMember(Name = "FreeThrowsAttempted", Order = 26)]
    ...
    [DataMember(Name = "FreeThrowsPercentage", Order = 27)]
    ...
    [DataMember(Name = "OffensiveRebounds", Order = 28)]
    ...
    [DataMember(Name = "DefensiveRebounds", Order = 29)]
    ...
    [DataMember(Name = "Rebounds", Order = 30)]
    ...
    [DataMember(Name = "OffensiveReboundsPercentage", Order = 31)]
    ...
    [DataMember(Name = "DefensiveReboundsPercentage", Order = 32)]
    ...
    [DataMember(Name = "TotalReboundsPercentage", Order = 33)]
    ...
    [DataMember(Name = "Assists", Order = 34)]
    ...
    [DataMember(Name = "Steals", Order = 35)]
    ...
    [DataMember(Name = "Turnovers", Order = 37)]
    ...
    [DataMember(Name = "PersonalFouls", Order = 38)]
    ...
    [DataMember(Name = "Points", Order = 39)]
    ...
    [DataMember(Name = "TrueShootingAttempts", Order = 40)]
    ...
    [DataMember(Name = "TrueShootingPercentage", Order = 41)]
    ...
    [DataMember(Name = "PlayerEfficiencyRating", Order = 42)]
    ...
    [DataMember(Name = "AssistsPercentage", Order = 43)]
    ...
    [DataMember(Name = "StealsPercentage", Order = 44)]
    ...
    [DataMember(Name = "BlocksPercentage", Order = 45)]
    ...
    [DataMember(Name = "TurnOversPercentage", Order = 46)]
    ...
    [DataMember(Name = "UsageRatePercentage", Order = 47)]
    ...
    [DataMember(Name = "FantasyPointsFanDuel", Order = 48)]
    ...
    [DataMember(Name = "FantasyPointsDraftKings", Order = 49)]
    ...
    [DataMember(Name = "FantasyPointsYahoo", Order = 50)]
    ...
    [DataMember(Name = "PlusMinus", Order = 51)]
    ...
    [DataMember(Name = "DoubleDoubles", Order = 52)]
    ...
    [DataMember(Name = "TripleDoubles", Order = 53)]
    ...
    [DataMember(Name = "FantasyPointsFantasyDraft", Order = 54)]
    ...
    [DataMember(Name = "IsClosed", Order = 55)]
    ...
    [DataMember(Name = "LineupConfirmed", Order = 56)]
    ...
    [DataMember(Name = "LineupStatus", Order = 57)]
