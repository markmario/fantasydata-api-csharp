...
public class Soccerv3OddsClient : BaseClient
{
    public Soccerv3OddsClient(string apiKey, HttpClient client) : base(apiKey, client)
    {
    ...
    public Task<List<GameInfo>> GetGameOddsByDateAsync(string date)
    {
        ...
        return this.GetAsync<List<GameInfo>>("/v3/soccer/odds/{format}/GameOddsByDate/{date}", parameters);
    }
    ...
    public Task<List<GameInfo>> GetGameOddsLineMovementAsync(int gameid)
    {
        ...
        return this.GetAsync<List<GameInfo>>("/v3/soccer/odds/{format}/GameOddsLineMovement/{gameid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<GameInfo>>("/v3/soccer/odds/{format}/LiveGameOddsByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("gameid", gameid.ToString())};
        return this.GetAsync<List<GameInfo>>("/v3/soccer/odds/{format}/LiveGameOddsLineMovement/{gameid}", parameters);
    }
    ...
    public Task<List<GameInfo>> GetPreGameOddsByDateByCompetitionAsync(string competition, string date)
    {
        ...
        return this.GetAsync<List<GameInfo>>(
            "/v3/soccer/odds/{format}/PreGameOddsByDateByCompetition/{competition}/{date}", parameters);
    }
    ...
    public Task<List<Sportsbook>> GetActiveSportsbooksAsync()
    {
        ...
        return this.GetAsync<List<Sportsbook>>("/v3/soccer/odds/{format}/ActiveSportsbooks", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("competition", competition), new("date", date)};
        return this.GetAsync<List<BettingEvent>>("/v3/soccer/odds/{format}/BettingEventsByDate/{competition}/{date}",
            parameters);
    }
    ...
    public Task<List<BettingEvent>> GetBettingEventsAsync(string competition, string season)
    {
        var parameters = new List<KeyValuePair<string, string>>
        {
            new("competition", competition), new("season", season)
        };
        return this.GetAsync<List<BettingEvent>>("/v3/soccer/odds/{format}/BettingEvents/{competition}/{season}",
            parameters);
    }
    ...
    public Task<List<BettingEvent>> GetBettingFuturesBySeasonAsync(string competition, string season)
    {
        ...
        return this.GetAsync<List<BettingEvent>>(
            "/v3/soccer/odds/{format}/BettingFuturesBySeason/{competition}/{season}", parameters);
    }
    ...
    public Task<BettingMarket> GetBettingMarketAsync(string marketId)
    {
        ...
        return this.GetAsync<BettingMarket>("/v3/soccer/odds/{format}/BettingMarket/{marketId}", parameters);
    }
    ...
    public Task<List<BettingMarket>> GetBettingMarketsAsync(string eventId)
    {
        ...
        return this.GetAsync<List<BettingMarket>>("/v3/soccer/odds/{format}/BettingMarkets/{eventId}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("gameid", gameid.ToString())};
        return this.GetAsync<List<BettingMarket>>("/v3/soccer/odds/{format}/BettingMarketsByGameID/{gameid}",
            parameters);
    }
    ...
    public Task<List<BettingMarket>> GetBettingMarketsByMarketTypeAsync(string eventId, string marketTypeID)
    {
        ...
        return this.GetAsync<List<BettingMarket>>(
            "/v3/soccer/odds/{format}/BettingMarketsByMarketType/{eventId}/{marketTypeID}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<BettingEntityMetadataCollection>("/v3/soccer/odds/{format}/BettingMetadata", parameters);
    }
    ...
    public Task<List<BettingMarket>> GetBettingPlayerPropsByDateAsync(string competition, string date)
    {
        var parameters = new List<KeyValuePair<string, string>> {new("competition", competition), new("date", date)};
        return this.GetAsync<List<BettingMarket>>(
            "/v3/soccer/odds/{format}/BettingPlayerPropsByDate/{competition}/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("gameId", gameId.ToString())};
        return this.GetAsync<List<BettingMarket>>("/v3/soccer/odds/{format}/BettingPlayerPropsByGameID/{gameId}",
            parameters);
    }
}