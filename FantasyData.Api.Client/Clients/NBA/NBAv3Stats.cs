...
public partial class NBAv3StatsClient : BaseClient
{
    ...
    public Task<bool> GetAreAnyGamesInProgressAsync()
    {
        ...
        return this.GetAsync<bool>("/v3/nba/stats/{format}/AreAnyGamesInProgress", parameters);
    }
    ...
    public Task<BoxScore> GetBoxScoreAsync(int gameid)
    {
        ...
        return this.GetAsync<BoxScore>("/v3/nba/stats/{format}/BoxScore/{gameid}", parameters);
    }
    ...
    public Task<List<BoxScore>> GetBoxScoresAsync(string date)
    {
        ...
        return this.GetAsync<List<BoxScore>>("/v3/nba/stats/{format}/BoxScores/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<Season>("/v3/nba/stats/{format}/CurrentSeason", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<DfsSlate>>("/v3/nba/stats/{format}/DfsSlatesByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<Game>>("/v3/nba/stats/{format}/GamesByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<News>>("/v3/nba/stats/{format}/News", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<News>>("/v3/nba/stats/{format}/NewsByDate/{date}", parameters);
    }
    ...
    public Task<List<News>> GetNewsByPlayerIDAsync(int playerid)
    {
        ...
        return this.GetAsync<List<News>>("/v3/nba/stats/{format}/NewsByPlayerID/{playerid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Player>>("/v3/nba/stats/{format}/Players", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Player>>("/v3/nba/stats/{format}/FreeAgents", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("playerid", playerid.ToString())};
        return this.GetAsync<Player>("/v3/nba/stats/{format}/Player/{playerid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<PlayerGame>>("/v3/nba/stats/{format}/PlayerGameStatsByDate/{date}", parameters);
    }
    ...
    public Task<PlayerGame> GetPlayerGameStatsByPlayerAsync(string date, int playerid)
    {
        ...
        return this.GetAsync<PlayerGame>("/v3/nba/stats/{format}/PlayerGameStatsByPlayer/{date}/{playerid}",
            parameters);
    }
    ...
    public Task<List<PlayerSeason>> GetPlayerSeasonStatsAsync(string season)
    {
        ...
        return this.GetAsync<List<PlayerSeason>>("/v3/nba/stats/{format}/PlayerSeasonStats/{season}", parameters);
    }
    ...
    public Task<PlayerSeason> GetPlayerSeasonStatsByPlayerAsync(string season, int playerid)
    {
        ...
        return this.GetAsync<PlayerSeason>("/v3/nba/stats/{format}/PlayerSeasonStatsByPlayer/{season}/{playerid}",
            parameters);
    }
    ...
    public Task<List<PlayerSeason>> GetPlayerSeasonStatsByTeamAsync(string season, string team)
    {
        ...
        return this.GetAsync<List<PlayerSeason>>("/v3/nba/stats/{format}/PlayerSeasonStatsByTeam/{season}/{team}",
            parameters);
    }
    ...
    public Task<List<Player>> GetPlayersAsync(string team)
    {
        ...
        return this.GetAsync<List<Player>>("/v3/nba/stats/{format}/Players/{team}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<Game>>("/v3/nba/stats/{format}/Games/{season}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Stadium>>("/v3/nba/stats/{format}/Stadiums", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<Standing>>("/v3/nba/stats/{format}/Standings/{season}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<TeamGame>>("/v3/nba/stats/{format}/TeamGameStatsByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<TeamSeason>>("/v3/nba/stats/{format}/TeamSeasonStats/{season}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<TeamSeason>>("/v3/nba/stats/{format}/TeamStatsAllowedByPosition/{season}",
            parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Team>>("/v3/nba/stats/{format}/teams", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Team>>("/v3/nba/stats/{format}/AllTeams", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<PlayerInfo>>("/v3/nba/stats/{format}/AllStars/{season}", parameters);
    }
    ...
    public Task<List<PlayerGame>> GetPlayerGameStatsBySeasonAsync(string season, int playerid, string numberofgames)
    {
        ...
        return this.GetAsync<List<PlayerGame>>(
            "/v3/nba/stats/{format}/PlayerGameStatsBySeason/{season}/{playerid}/{numberofgames}", parameters);
    }
}