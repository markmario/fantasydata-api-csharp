...
public partial class NBAv3OddsClient : BaseClient
{
    ...
    public Task<List<GameInfo>> GetLiveGameOddsByDateAsync(string date)
    {
        ...
        return this.GetAsync<List<GameInfo>>("/v3/nba/odds/{format}/LiveGameOddsByDate/{date}", parameters);
    }
    ...
    public Task<List<GameInfo>> GetLiveGameOddsLineMovementAsync(int gameid)
    {
        ...
        return this.GetAsync<List<GameInfo>>("/v3/nba/odds/{format}/LiveGameOddsLineMovement/{gameid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<GameInfo>>("/v3/nba/odds/{format}/GameOddsByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("gameid", gameid.ToString())};
        return this.GetAsync<List<GameInfo>>("/v3/nba/odds/{format}/GameOddsLineMovement/{gameid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<PlayerProp>>("/v3/nba/odds/{format}/PlayerPropsByDate/{date}", parameters);
    }
    ...
    public Task<List<PlayerProp>> GetPlayerPropsByPlayerIDAsync(string date, int playerid)
    {
        ...
        return this.GetAsync<List<PlayerProp>>("/v3/nba/odds/{format}/PlayerPropsByPlayerID/{date}/{playerid}",
            parameters);
    }
    ...
    public Task<List<PlayerProp>> GetPlayerPropsByTeamAsync(string date, string team)
    {
        ...
        return this.GetAsync<List<PlayerProp>>("/v3/nba/odds/{format}/PlayerPropsByTeam/{date}/{team}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<GameInfo>>("/v3/nba/odds/{format}/AlternateMarketGameOddsByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("gameid", gameid.ToString())};
        return this.GetAsync<List<GameInfo>>("/v3/nba/odds/{format}/AlternateMarketGameOddsLineMovement/{gameid}",
            parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<BettingEvent>>("/v3/nba/odds/{format}/BettingEventsByDate/{date}", parameters);
    }
    ...
    public Task<List<BettingEvent>> GetBettingEventsAsync(string season)
    {
        ...
        return this.GetAsync<List<BettingEvent>>("/v3/nba/odds/{format}/BettingEvents/{season}", parameters);
    }
    ...
    public Task<BettingMarket> GetBettingMarketAsync(string marketId)
    {
        ...
        return this.GetAsync<BettingMarket>("/v3/nba/odds/{format}/BettingMarket/{marketId}", parameters);
    }
    ...
    public Task<List<BettingMarket>> GetBettingMarketsAsync(string eventId)
    {
        ...
        return this.GetAsync<List<BettingMarket>>("/v3/nba/odds/{format}/BettingMarkets/{eventId}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<BettingEvent>>("/v3/nba/odds/{format}/BettingFuturesBySeason/{season}", parameters);
    }
    ...
    public Task<List<BettingMarket>> GetBettingMarketsByMarketTypeAsync(string eventId, string marketTypeID)
    {
        ...
        return this.GetAsync<List<BettingMarket>>(
            "/v3/nba/odds/{format}/BettingMarketsByMarketType/{eventId}/{marketTypeID}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<BettingEvent>>("/v3/nba/odds/{format}/BettingPlayerPropsByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("gameID", gameID.ToString())};
        return this.GetAsync<List<BettingMarket>>("/v3/nba/odds/{format}/BettingMarketsByGameID/{gameID}", parameters);
    }
    ...
    public Task<MatchupTrends> GetMatchupTrendsAsync(string team, string opponent)
    {
        ...
        return this.GetAsync<MatchupTrends>("/v3/nba/odds/{format}/MatchupTrends/{team}/{opponent}", parameters);
    }
    ...
    public Task<TeamTrends> GetTeamTrendsAsync(string team)
    {
        ...
        return this.GetAsync<TeamTrends>("/v3/nba/odds/{format}/TeamTrends/{team}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<BettingEntityMetadata>>("/v3/nba/odds/{format}/BettingMetadata", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Sportsbook>>("/v3/nba/odds/{format}/ActiveSportsbooks", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("marketId", marketId)};
        return this.GetAsync<BettingMarketResult>("/v3/nba/odds/{format}/BettingMarketResults/{marketId}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("marketId", marketId)};
        return this.GetAsync<BettingMarketSplit>("/v3/nba/odds/{format}/BettingSplitsByMarketId/{marketId}",
            parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("gameId", gameId.ToString())};
        return this.GetAsync<GameBettingSplit>("/v3/nba/odds/{format}/BettingSplitsByGameId/{gameId}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("gameId", gameId.ToString())};
        return this.GetAsync<List<BettingMarket>>("/v3/nba/odds/{format}/BettingPlayerPropsByGameID/{gameId}",
            parameters);
    }
}