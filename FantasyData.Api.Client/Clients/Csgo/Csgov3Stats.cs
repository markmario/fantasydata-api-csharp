...
public partial class Csgov3StatsClient : BaseClient
{
    public Csgov3StatsClient(string apiKey) : base(apiKey)
    {
    }

    public Csgov3StatsClient(Guid apiKey) : base(apiKey)
    {
    }
    ...
    public Task<List<Area>> GetAreasAsync()
    {
        ...
        return this.GetAsync<List<Area>>("/v3/csgo/stats/{format}/Areas", parameters);
    }
    ...
    public Task<List<BoxScore>> GetBoxScoreAsync(int gameid)
    {
        ...
        return this.GetAsync<List<BoxScore>>("/v3/csgo/stats/{format}/BoxScore/{gameid}", parameters);
    }
    ...
    public Task<List<BoxScore>> GetBoxScoresAsync(string date)
    {
        ...
        return this.GetAsync<List<BoxScore>>("/v3/csgo/stats/{format}/BoxScores/{date}", parameters);
    }
    ...
    public Task<CompetitionDetail> GetCompetitionDetailsAsync(string competitionid)
    {
        ...
        return this.GetAsync<CompetitionDetail>("/v3/csgo/stats/{format}/CompetitionDetails/{competitionid}",
            parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Competition>>("/v3/csgo/stats/{format}/Competitions", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<Game>>("/v3/csgo/stats/{format}/GamesByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Membership>>("/v3/csgo/stats/{format}/ActiveMemberships", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Membership>>("/v3/csgo/stats/{format}/HistoricalMemberships", parameters);
    }
    ...
    public Task<List<Membership>> GetMembershipsByTeamAsync(int teamid)
    {
        ...
        return this.GetAsync<List<Membership>>("/v3/csgo/stats/{format}/MembershipsByTeam/{teamid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("teamid", teamid.ToString())};
        return this.GetAsync<List<Membership>>("/v3/csgo/stats/{format}/HistoricalMembershipsByTeam/{teamid}",
            parameters);
    }
    ...
    public Task<Player> GetPlayerAsync(int playerid)
    {
        ...
        return this.GetAsync<Player>("/v3/csgo/stats/{format}/Player/{playerid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Player>>("/v3/csgo/stats/{format}/Players", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("teamid", teamid.ToString())};
        return this.GetAsync<List<Player>>("/v3/csgo/stats/{format}/PlayersByTeam/{teamid}", parameters);
    }
    ...
    public Task<List<Game>> GetScheduleAsync(int roundid)
    {
        ...
        return this.GetAsync<List<Game>>("/v3/csgo/stats/{format}/Schedule/{roundid}", parameters);
    }
    ...
    public Task<List<SeasonTeam>> GetSeasonTeamsAsync(int seasonid)
    {
        ...
        return this.GetAsync<List<SeasonTeam>>("/v3/csgo/stats/{format}/SeasonTeams/{seasonid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Team>>("/v3/csgo/stats/{format}/Teams", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Venue>>("/v3/csgo/stats/{format}/Venues", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("roundid", roundid.ToString())};
        return this.GetAsync<List<Standing>>("/v3/csgo/stats/{format}/Standings/{roundid}", parameters);
    }
}