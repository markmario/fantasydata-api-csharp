...
public class NHLv2Client : BaseClient
{
    public NHLv2Client(string apiKey, HttpClient client) : base(apiKey, client)
    {
    ...
    public Task<bool> GetAreAnyGamesInProgressAsync()
    {
        ...
        return this.GetAsync<bool>("/nhl/v2/{format}/AreAnyGamesInProgress", parameters);
    }
    ...
    public Task<BoxScore> GetBoxScoreAsync(int gameid)
    {
        ...
        return this.GetAsync<BoxScore>("/nhl/v2/{format}/BoxScore/{gameid}", parameters);
    }
    ...
    public Task<List<BoxScore>> GetBoxScoresAsync(string date)
    {
        ...
        return this.GetAsync<List<BoxScore>>("/nhl/v2/{format}/BoxScores/{date}", parameters);
    }
    ...
    public Task<List<BoxScore>> GetBoxScoresDeltaAsync(string date, string minutes)
    {
        ...
        return this.GetAsync<List<BoxScore>>("/nhl/v2/{format}/BoxScoresDelta/{date}/{minutes}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<Season>("/nhl/v2/{format}/CurrentSeason", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<Game>>("/nhl/v2/{format}/GamesByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<News>>("/nhl/v2/{format}/News", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<News>>("/nhl/v2/{format}/NewsByDate/{date}", parameters);
    }
    ...
    public Task<List<News>> GetNewsByPlayerIDAsync(int playerid)
    {
        ...
        return this.GetAsync<List<News>>("/nhl/v2/{format}/NewsByPlayerID/{playerid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Player>>("/nhl/v2/{format}/Players", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Player>>("/nhl/v2/{format}/FreeAgents", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("playerid", playerid.ToString())};
        return this.GetAsync<Player>("/nhl/v2/{format}/Player/{playerid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<PlayerGame>>("/nhl/v2/{format}/PlayerGameStatsByDate/{date}", parameters);
    }
    ...
    public Task<PlayerGame> GetPlayerGameStatsByPlayerAsync(string date, int playerid)
    {
        ...
        return this.GetAsync<PlayerGame>("/nhl/v2/{format}/PlayerGameStatsByPlayer/{date}/{playerid}", parameters);
    }
    ...
    public Task<List<PlayerSeason>> GetPlayerSeasonStatsAsync(string season)
    {
        ...
        return this.GetAsync<List<PlayerSeason>>("/nhl/v2/{format}/PlayerSeasonStats/{season}", parameters);
    }
    ...
    public Task<PlayerSeason> GetPlayerSeasonStatsByPlayerAsync(string season, int playerid)
    {
        ...
        return this.GetAsync<PlayerSeason>("/nhl/v2/{format}/PlayerSeasonStatsByPlayer/{season}/{playerid}",
            parameters);
    }
    ...
    public Task<List<PlayerSeason>> GetPlayerSeasonStatsByTeamAsync(string season, string team)
    {
        ...
        return this.GetAsync<List<PlayerSeason>>("/nhl/v2/{format}/PlayerSeasonStatsByTeam/{season}/{team}",
            parameters);
    }
    ...
    public Task<List<Player>> GetPlayersAsync(string team)
    {
        ...
        return this.GetAsync<List<Player>>("/nhl/v2/{format}/Players/{team}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<PlayerGameProjection>>("/nhl/v2/{format}/PlayerGameProjectionStatsByDate/{date}",
            parameters);
    }
    ...
    public Task<PlayerGameProjection> GetPlayerGameProjectionStatsByPlayerAsync(string date, int playerid)
    {
        ...
        return this.GetAsync<PlayerGameProjection>(
            "/nhl/v2/{format}/PlayerGameProjectionStatsByPlayer/{date}/{playerid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<Game>>("/nhl/v2/{format}/Games/{season}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Stadium>>("/nhl/v2/{format}/Stadiums", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<Standing>>("/nhl/v2/{format}/Standings/{season}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<TeamGame>>("/nhl/v2/{format}/TeamGameStatsByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<TeamSeason>>("/nhl/v2/{format}/TeamSeasonStats/{season}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<TeamSeason>>("/nhl/v2/{format}/TeamStatsAllowedByPosition/{season}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Team>>("/nhl/v2/{format}/teams", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Team>>("/nhl/v2/{format}/AllTeams", parameters);
    }
}