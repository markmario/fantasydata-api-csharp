...
public class NHLv3ScoresClient : BaseClient
{
    public NHLv3ScoresClient(string apiKey, HttpClient client) : base(apiKey, client)
    {
    ...
    public Task<bool> GetAreAnyGamesInProgressAsync()
    {
        ...
        return this.GetAsync<bool>("/v3/nhl/scores/{format}/AreAnyGamesInProgress", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<Season>("/v3/nhl/scores/{format}/CurrentSeason", parameters);
    }
    ...
    public Task<List<Game>> GetGamesByDateAsync(string date)
    {
        ...
        return this.GetAsync<List<Game>>("/v3/nhl/scores/{format}/GamesByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<News>>("/v3/nhl/scores/{format}/News", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<News>>("/v3/nhl/scores/{format}/NewsByDate/{date}", parameters);
    }
    ...
    public Task<List<News>> GetNewsByPlayerIDAsync(int playerid)
    {
        ...
        return this.GetAsync<List<News>>("/v3/nhl/scores/{format}/NewsByPlayerID/{playerid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Player>>("/v3/nhl/scores/{format}/Players", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Player>>("/v3/nhl/scores/{format}/FreeAgents", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("playerid", playerid.ToString())};
        return this.GetAsync<Player>("/v3/nhl/scores/{format}/Player/{playerid}", parameters);
    }
    ...
    public Task<List<Player>> GetPlayersAsync(string team)
    {
        ...
        return this.GetAsync<List<Player>>("/v3/nhl/scores/{format}/Players/{team}", parameters);
    }
    ...
    public Task<List<Game>> GetGamesAsync(string season)
    {
        ...
        return this.GetAsync<List<Game>>("/v3/nhl/scores/{format}/Games/{season}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Stadium>>("/v3/nhl/scores/{format}/Stadiums", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<Standing>>("/v3/nhl/scores/{format}/Standings/{season}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("date", date)};
        return this.GetAsync<List<TeamGame>>("/v3/nhl/scores/{format}/TeamGameStatsByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("season", season)};
        return this.GetAsync<List<TeamSeason>>("/v3/nhl/scores/{format}/TeamSeasonStats/{season}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Team>>("/v3/nhl/scores/{format}/teams", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Team>>("/v3/nhl/scores/{format}/AllTeams", parameters);
    }
}