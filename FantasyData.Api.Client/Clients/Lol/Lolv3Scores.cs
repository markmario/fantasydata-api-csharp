...
public class Lolv3ScoresClient : BaseClient
{
    ...
    public Task<List<Area>> GetAreasAsync()
    {
        ...
        return this.GetAsync<List<Area>>("/v3/lol/scores/{format}/Areas", parameters);
    }
    ...
    public Task<CompetitionDetail> GetCompetitionDetailsAsync(string competitionid)
    {
        ...
        return this.GetAsync<CompetitionDetail>("/v3/lol/scores/{format}/CompetitionDetails/{competitionid}",
            parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Competition>>("/v3/lol/scores/{format}/Competitions", parameters);
    }
    ...
    public Task<List<Game>> GetGamesByDateAsync(string date)
    {
        ...
        return this.GetAsync<List<Game>>("/v3/lol/scores/{format}/GamesByDate/{date}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Membership>>("/v3/lol/scores/{format}/ActiveMemberships", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Membership>>("/v3/lol/scores/{format}/HistoricalMemberships", parameters);
    }
    ...
    public Task<List<Membership>> GetMembershipsByTeamAsync(int teamid)
    {
        ...
        return this.GetAsync<List<Membership>>("/v3/lol/scores/{format}/MembershipsByTeam/{teamid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("teamid", teamid.ToString())};
        return this.GetAsync<List<Membership>>("/v3/lol/scores/{format}/HistoricalMembershipsByTeam/{teamid}",
            parameters);
    }
    ...
    public Task<Player> GetPlayerAsync(int playerid)
    {
        ...
        return this.GetAsync<Player>("/v3/lol/scores/{format}/Player/{playerid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Player>>("/v3/lol/scores/{format}/Players", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("teamid", teamid.ToString())};
        return this.GetAsync<List<Player>>("/v3/lol/scores/{format}/PlayersByTeam/{teamid}", parameters);
    }
    ...
    public Task<List<Game>> GetScheduleAsync(int roundid)
    {
        ...
        return this.GetAsync<List<Game>>("/v3/lol/scores/{format}/Schedule/{roundid}", parameters);
    }
    ...
    public Task<List<SeasonTeam>> GetSeasonTeamsAsync(int seasonid)
    {
        ...
        return this.GetAsync<List<SeasonTeam>>("/v3/lol/scores/{format}/SeasonTeams/{seasonid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>> {new("roundid", roundid.ToString())};
        return this.GetAsync<List<Standing>>("/v3/lol/scores/{format}/Standings/{roundid}", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Team>>("/v3/lol/scores/{format}/Teams", parameters);
    }
    ...
    {
        var parameters = new List<KeyValuePair<string, string>>();
        return this.GetAsync<List<Venue>>("/v3/lol/scores/{format}/Venues", parameters);
    }
}